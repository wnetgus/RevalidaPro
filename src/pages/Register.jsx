...
const Register = () => {
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      // onAuthStateChanged no App.jsx assume o controle
    } catch (error) {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // Envia email de verificação em paralelo — não bloqueia o acesso
      sendEmailVerification(userCredential.user).catch(() => {});

      setLoading(false);
      // Usuário já autenticado — redireciona imediatamente para a plataforma
      // O App.jsx exibe um banner discreto pedindo confirmação do email
      navigate("/");
          ...
          <div style={{ maxWidth: "480px", width: "100%", margin: "0 auto" }}>
            ...
            <button
              ...
              style={{
                ...
                opacity: loadingGoogle ? 0.7 : 1, marginBottom: "4px",
              }}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", margin: "8px 0" }}>
              ...
              <span style={{ color: "#475569", fontSize: "12px", fontWeight: "600" }}>ou cadastre-se com e-mail</span>
              <div style={{ flex: 1, height: "1px", background: "#1e293b" }} />
            </div>
